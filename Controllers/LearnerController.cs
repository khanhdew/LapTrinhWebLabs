...
public class LearnerController : Controller
{
    ...
    public IActionResult Index(int? mid)
    {
        ...
        {
            var learners = db.Learners.Where(l=>l.MajorID==mid).Include(l => l.Major).ToList();
            return View(learners);
        }
    }
    ...
    public IActionResult Edit(int id, [Bind("LearnerID,FirstMidName,LastName,MajorID,EnrollmentDate")] Learner learner)
    {
        ...
        ViewBag.MajorId = new SelectList(db.Majors,
            "MajorID",
            "MajorName",
            learner.MajorID);
        return View(learner);
    ...
    private bool LearnerExists(int learnerLearnerId)
    {
        return db.Learners.Any(e => e.LearnerID == learnerLearnerId);
    }
